...
class IntegrationTestn8nSettings(IntegrationTestCase):
	...
	@patch("frappe_n8n.integrations.n8n.requests.get")
	...
	def setUp(self, mock_enqueue, mock_get):
		...
		mock_get.return_value.json.return_value = {"data": [{"id": "personal_123", "type": "personal"}]}
	...
	@patch("frappe_controller.utils.controller.emit_event")
	@patch("frappe_n8n.integrations.n8n.requests.patch")
	@patch("frappe_n8n.integrations.n8n.requests.put")
